...
internal static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        // across rows. Use `cs.AddText(saveRestore: false)` for the rare
        ...
        // cs.Restore(). The Text is constructed with saveRestore:false so it
        // emits BT … ET without its own q/Q wrap.
        Label("Tr=7");
        ...
        cs.AddText()
            .SetFont(Standard14Font.HelveticaOblique, 8)
            .SetGrayFill(0.55)
            .Show(LabelX, PageSizes.A4.Height - 35,
                "Generated by PdfSpec. Generated on " + DateTime.Now.ToLongTimeString())
            .Build();
