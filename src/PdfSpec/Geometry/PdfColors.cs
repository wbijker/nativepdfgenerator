...
/// <paramref name="shade"/> and optional <paramref name="alpha"/>.
///
/// <para>
...
///
/// <para>
/// Example: <c>PdfColors.Red(2, 0.2)</c> → red-200 with 20% alpha.
/// </para>
/// </summary>
public static class PdfColors
{
    /// <summary>Pure white — 0xFFFFFF.</summary>
    public static PdfColor White(double alpha = 1.0) => PdfColor.Rgb(1, 1, 1, alpha);

    /// <summary>Pure black — 0x000000.</summary>
    public static PdfColor Black(double alpha = 1.0) => PdfColor.Rgb(0, 0, 0, alpha);
    ...
    public static PdfColor Slate(int shade = 500, double alpha = 1.0) => Pick(_slate, shade, alpha);
    ...
    public static PdfColor Gray(int shade = 500, double alpha = 1.0) => Pick(_gray, shade, alpha);
    ...
    public static PdfColor Zinc(int shade = 500, double alpha = 1.0) => Pick(_zinc, shade, alpha);
    ...
    public static PdfColor Neutral(int shade = 500, double alpha = 1.0) => Pick(_neutral, shade, alpha);
    ...
    public static PdfColor Stone(int shade = 500, double alpha = 1.0) => Pick(_stone, shade, alpha);
    ...
    public static PdfColor Red(int shade = 500, double alpha = 1.0) => Pick(_red, shade, alpha);
    ...
    public static PdfColor Orange(int shade = 500, double alpha = 1.0) => Pick(_orange, shade, alpha);
    ...
    public static PdfColor Amber(int shade = 500, double alpha = 1.0) => Pick(_amber, shade, alpha);
    ...
    public static PdfColor Yellow(int shade = 500, double alpha = 1.0) => Pick(_yellow, shade, alpha);
    ...
    public static PdfColor Lime(int shade = 500, double alpha = 1.0) => Pick(_lime, shade, alpha);
    ...
    public static PdfColor Green(int shade = 500, double alpha = 1.0) => Pick(_green, shade, alpha);
    ...
    public static PdfColor Emerald(int shade = 500, double alpha = 1.0) => Pick(_emerald, shade, alpha);
    ...
    public static PdfColor Teal(int shade = 500, double alpha = 1.0) => Pick(_teal, shade, alpha);
    ...
    public static PdfColor Cyan(int shade = 500, double alpha = 1.0) => Pick(_cyan, shade, alpha);
    ...
    public static PdfColor Sky(int shade = 500, double alpha = 1.0) => Pick(_sky, shade, alpha);
    ...
    public static PdfColor Blue(int shade = 500, double alpha = 1.0) => Pick(_blue, shade, alpha);
    ...
    public static PdfColor Indigo(int shade = 500, double alpha = 1.0) => Pick(_indigo, shade, alpha);
    ...
    public static PdfColor Violet(int shade = 500, double alpha = 1.0) => Pick(_violet, shade, alpha);
    ...
    public static PdfColor Purple(int shade = 500, double alpha = 1.0) => Pick(_purple, shade, alpha);
    ...
    public static PdfColor Fuchsia(int shade = 500, double alpha = 1.0) => Pick(_fuchsia, shade, alpha);
    ...
    public static PdfColor Pink(int shade = 500, double alpha = 1.0) => Pick(_pink, shade, alpha);
    ...
    public static PdfColor Rose(int shade = 500, double alpha = 1.0) => Pick(_rose, shade, alpha);

    // ===== Helpers ============================================================

    private static PdfColor Pick(int[] palette, int shade, double alpha) =>
        PdfColor.FromHex(palette[ShadeIndex(shade)], alpha);
