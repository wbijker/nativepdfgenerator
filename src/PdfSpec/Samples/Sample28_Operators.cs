...
public sealed class Sample28_Operators : ISample
{
    ...
    public void Build(string path)
    {
        ...
        var c = page.Content;
        c.AddText(StandardFont.Helvetica, 22).Show(60, 740, "Additional Operators").Build();

        c.AddText(StandardFont.Helvetica, 11).Show(60, 700, "Pentagram fill: nonzero (b) vs even-odd (b*)").Build();
        ...
        c.AddText(StandardFont.Helvetica, 11).Show(420, 700, "v / y Bézier curves").Build();
        ...
        c.AddText(StandardFont.Helvetica, 14).SetLeading(20).SetTextMatrix(1, 0, 0, 1, 60, 540)
        ...
        c.AddText(StandardFont.Helvetica, 11).Show(60, 470, "Inline image (BI/ID/EI):").Build();
