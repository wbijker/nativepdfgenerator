...
/// <summary>
/// A node in the document outline (Chapter 5, "Bookmarks or Outlines"). Each item
/// has a title, an optional destination or action, and child items. The
/// <see cref="Open"/> flag controls whether children are shown expanded; it also
/// determines the sign of the generated Count entry.
/// </summary>
